...
The repository keeps a curated set of source-embedded autogenerated checks for
cases where a broad function or module shape is itself the contract. They
