...
// CHECK-NEXT:   %7 = getelementptr inbounds %"{{.*}}/cl/_testrt/float2any.eface", ptr %5, i32 0, i32 1
// CHECK-NEXT:   %8 = load ptr, ptr %7, align 8
// CHECK-NEXT:   %9 = load i32, ptr %8, align 4
// CHECK-NEXT:   %10 = icmp ne i32 %9, 1078530011
...
// CHECK-NEXT:   store %"{{.*}}/runtime/internal/runtime.String" { ptr @1, i64 14 }, ptr %11, align 8
...
// CHECK-NEXT:   store %"{{.*}}/runtime/internal/runtime.String" { ptr @3, i64 14 }, ptr %13, align 8
...
// CHECK-NEXT:   %15 = extractvalue %"{{.*}}/runtime/internal/runtime.eface" %2, 1
// CHECK-NEXT:   %16 = load float, ptr %15, align 4
// CHECK-NEXT:   %17 = insertvalue { float, i1 } undef, float %16, 0
// CHECK-NEXT:   %18 = insertvalue { float, i1 } %17, i1 true, 1
...
// CHECK-NEXT:   %19 = phi { float, i1 } [ %18, %_llgo_5 ], [ zeroinitializer, %_llgo_6 ]
// CHECK-NEXT:   %20 = extractvalue { float, i1 } %19, 0
// CHECK-NEXT:   %21 = extractvalue { float, i1 } %19, 1
...
// CHECK-NEXT:   %10 = load %"{{.*}}/cl/_testrt/float2any.u64parts", ptr %9, align 4
// CHECK-NEXT:   store %"{{.*}}/cl/_testrt/float2any.u64parts" %10, ptr %7, align 4
// CHECK-NEXT:   %11 = getelementptr inbounds %"{{.*}}/cl/_testrt/float2any.u64parts", ptr %7, i32 0, i32 0
// CHECK-NEXT:   %12 = load i32, ptr %11, align 4
// CHECK-NEXT:   %13 = icmp ne i32 %12, 1405670641
// CHECK-NEXT:   br i1 %13, label %_llgo_3, label %_llgo_5
// CHECK-EMPTY:
// CHECK-NEXT: _llgo_2:                                          ; preds = %_llgo_8
// CHECK-NEXT:   %14 = call ptr @"{{.*}}/runtime/internal/runtime.AllocU"(i64 16)
// CHECK-NEXT:   store %"{{.*}}/runtime/internal/runtime.String" { ptr @5, i64 14 }, ptr %14, align 8
...
// CHECK-NEXT:   store %"{{.*}}/runtime/internal/runtime.String" { ptr @6, i64 14 }, ptr %16, align 8
...
// CHECK-NEXT:   %18 = getelementptr inbounds %"{{.*}}/cl/_testrt/float2any.u64parts", ptr %7, i32 0, i32 1
// CHECK-NEXT:   %19 = load i32, ptr %18, align 4
// CHECK-NEXT:   %20 = icmp ne i32 %19, 1074340347
// CHECK-NEXT:   br i1 %20, label %_llgo_3, label %_llgo_4
// CHECK-EMPTY:
// CHECK-NEXT: _llgo_6:                                          ; preds = %_llgo_0
// CHECK-NEXT:   %21 = extractvalue %"{{.*}}/runtime/internal/runtime.eface" %2, 1
// CHECK-NEXT:   %22 = load double, ptr %21, align 8
// CHECK-NEXT:   %23 = insertvalue { double, i1 } undef, double %22, 0
// CHECK-NEXT:   %24 = insertvalue { double, i1 } %23, i1 true, 1
...
// CHECK-NEXT:   %25 = phi { double, i1 } [ %24, %_llgo_6 ], [ zeroinitializer, %_llgo_7 ]
// CHECK-NEXT:   %26 = extractvalue { double, i1 } %25, 0
// CHECK-NEXT:   %27 = extractvalue { double, i1 } %25, 1
