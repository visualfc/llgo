...
// CHECK: {{^}}@0 = private unnamed_addr constant [14 x i8] c"Comp => Comp\0A\00", align 1{{$}}
// CHECK: {{^}}@1 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1{{$}}
// CHECK: {{^}}@2 = private unnamed_addr constant [12 x i8] c"fn => Comp\0A\00", align 1{{$}}
// CHECK: {{^}}@3 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1{{$}}
// CHECK: {{^}}@4 = private unnamed_addr constant [12 x i8] c"Comp => fn\0A\00", align 1{{$}}
// CHECK: {{^}}@5 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1{{$}}
// CHECK: {{^}}@6 = private unnamed_addr constant [10 x i8] c"fn => fn\0A\00", align 1{{$}}
// CHECK: {{^}}@7 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1{{$}}
// CHECK: {{^}}@8 = private unnamed_addr constant [26 x i8] c"qsort.Comp => qsort.Comp\0A\00", align 1{{$}}
// CHECK: {{^}}@9 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1{{$}}
// CHECK: {{^}}@10 = private unnamed_addr constant [18 x i8] c"fn => qsort.Comp\0A\00", align 1{{$}}
// CHECK: {{^}}@11 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1{{$}}
// CHECK: {{^}}@12 = private unnamed_addr constant [18 x i8] c"qsort.Comp => fn\0A\00", align 1{{$}}
// CHECK: {{^}}@13 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1{{$}}
// CHECK: {{^}}@14 = private unnamed_addr constant [18 x i8] c"Comp => qsort.fn\0A\00", align 1{{$}}
// CHECK: {{^}}@15 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1{{$}}
// CHECK: {{^}}@16 = private unnamed_addr constant [22 x i8] c"qsort.Comp => Comp()\0A\00", align 1{{$}}
// CHECK: {{^}}@17 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1{{$}}
// CHECK: {{^}}@18 = private unnamed_addr constant [22 x i8] c"Comp => qsort.Comp()\0A\00", align 1{{$}}
// CHECK: {{^}}@19 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1{{$}}
