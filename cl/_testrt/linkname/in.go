...
// CHECK: {{^}}@0 = private unnamed_addr constant [2 x i8] c"a\00", align 1{{$}}
// CHECK: {{^}}@1 = private unnamed_addr constant [2 x i8] c"b\00", align 1{{$}}
// CHECK: {{^}}@2 = private unnamed_addr constant [2 x i8] c"c\00", align 1{{$}}
// CHECK: {{^}}@3 = private unnamed_addr constant [2 x i8] c"d\00", align 1{{$}}
// CHECK: {{^}}@4 = private unnamed_addr constant [2 x i8] c"1\00", align 1{{$}}
// CHECK: {{^}}@5 = private unnamed_addr constant [2 x i8] c"2\00", align 1{{$}}
// CHECK: {{^}}@6 = private unnamed_addr constant [2 x i8] c"3\00", align 1{{$}}
// CHECK: {{^}}@7 = private unnamed_addr constant [2 x i8] c"4\00", align 1{{$}}
// CHECK: {{^}}@8 = private unnamed_addr constant [5 x i8] c"hello", align 1{{$}}
