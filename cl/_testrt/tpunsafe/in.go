...
// CHECK: {{^}}@0 = private unnamed_addr constant [4 x i8] c"have", align 1{{$}}
// CHECK: {{^}}@1 = private unnamed_addr constant [4 x i8] c"want", align 1{{$}}
// CHECK: {{^}}@2 = private unnamed_addr constant [20 x i8] c"unsafe.Alignof error", align 1{{$}}
// CHECK: {{^}}@4 = private unnamed_addr constant [21 x i8] c"unsafe.Offsetof error", align 1{{$}}
