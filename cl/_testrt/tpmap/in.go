...
// CHECK-NEXT:   %[[TMP2:[0-9]+]] = getelementptr inbounds nuw %main.cacheKey, ptr %[[TMP1]], i32 0, i32 0
// CHECK-NEXT:   %[[TMP3:[0-9]+]] = getelementptr inbounds nuw %main.cacheKey, ptr %[[TMP1]], i32 0, i32 1
// CHECK-NEXT:   %[[TMP4:[0-9]+]] = alloca %main.T2, align 8
// CHECK-NEXT:   call void @llvm.memset.p0.i64(ptr %[[TMP4]], i8 0, i64 8, i1 false)
// CHECK-NEXT:   %[[TMP5:[0-9]+]] = getelementptr inbounds nuw %main.T2, ptr %[[TMP4]], i32 0, i32 0
// CHECK-NEXT:   store i64 0, ptr %[[TMP5]], align 8
// CHECK-NEXT:   %[[TMP6:[0-9]+]] = load %main.T2, ptr %[[TMP4]], align 8
// CHECK-NEXT:   %[[TMP7:[0-9]+]] = getelementptr inbounds nuw %main.cacheKey, ptr %[[TMP1]], i32 0, i32 2
// CHECK-NEXT:   %[[TMP8:[0-9]+]] = alloca %"main.T3{{\[.*\]}}", align 8
// CHECK-NEXT:   call void @llvm.memset.p0.i64(ptr %[[TMP8]], i8 0, i64 16, i1 false)
// CHECK-NEXT:   %[[TMP9:[0-9]+]] = getelementptr inbounds nuw %"main.T3{{\[.*\]}}", ptr %[[TMP8]], i32 0, i32 0
...
// CHECK-NEXT:   %[[TMP13:[0-9]+]] = getelementptr inbounds nuw %main.cacheKey, ptr %[[TMP1]], i32 0, i32 3
// CHECK-NEXT:   %[[TMP14:[0-9]+]] = getelementptr inbounds nuw %main.cacheKey, ptr %[[TMP1]], i32 0, i32 4
...
// CHECK-NEXT:   %[[TMP19:[0-9]+]] = getelementptr inbounds nuw %main.cacheKey, ptr %[[TMP18]], i32 0, i32 0
// CHECK-NEXT:   %[[TMP20:[0-9]+]] = getelementptr inbounds nuw %main.cacheKey, ptr %[[TMP18]], i32 0, i32 1
// CHECK-NEXT:   %[[TMP21:[0-9]+]] = alloca %main.T2, align 8
// CHECK-NEXT:   call void @llvm.memset.p0.i64(ptr %[[TMP21]], i8 0, i64 8, i1 false)
// CHECK-NEXT:   %[[TMP22:[0-9]+]] = getelementptr inbounds nuw %main.T2, ptr %[[TMP21]], i32 0, i32 0
// CHECK-NEXT:   store i64 0, ptr %[[TMP22]], align 8
// CHECK-NEXT:   %[[TMP23:[0-9]+]] = load %main.T2, ptr %[[TMP21]], align 8
// CHECK-NEXT:   %[[TMP24:[0-9]+]] = getelementptr inbounds nuw %main.cacheKey, ptr %[[TMP18]], i32 0, i32 2
// CHECK-NEXT:   %[[TMP25:[0-9]+]] = alloca %"main.T3{{\[.*\]}}", align 8
// CHECK-NEXT:   call void @llvm.memset.p0.i64(ptr %[[TMP25]], i8 0, i64 16, i1 false)
// CHECK-NEXT:   %[[TMP26:[0-9]+]] = getelementptr inbounds nuw %"main.T3{{\[.*\]}}", ptr %[[TMP25]], i32 0, i32 0
...
// CHECK-NEXT:   %[[TMP30:[0-9]+]] = getelementptr inbounds nuw %main.cacheKey, ptr %[[TMP18]], i32 0, i32 3
// CHECK-NEXT:   %[[TMP31:[0-9]+]] = getelementptr inbounds nuw %main.cacheKey, ptr %[[TMP18]], i32 0, i32 4
