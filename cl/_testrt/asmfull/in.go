...
// CHECK: {{^}}@18 = private unnamed_addr constant [5 x i8] c"value", align 1{{$}}
// CHECK: {{^}}@19 = private unnamed_addr constant [7 x i8] c"Result:", align 1{{$}}
// CHECK: {{^}}@20 = private unnamed_addr constant [1 x i8] c"x", align 1{{$}}
// CHECK: {{^}}@21 = private unnamed_addr constant [1 x i8] c"y", align 1{{$}}
