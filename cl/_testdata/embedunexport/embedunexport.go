...
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   %1 = getelementptr inbounds %"{{.*}}/cl/_testdata/embedunexport.Base", ptr %0, i32 0, i32 0
...
// CHECK-NEXT:   %2 = getelementptr inbounds %"{{.*}}/cl/_testdata/embedunexport.Base", ptr %1, i32 0, i32 0
