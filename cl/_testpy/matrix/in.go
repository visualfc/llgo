...
// CHECK: {{^}}@0 = private unnamed_addr constant [8 x i8] c"a = %s\0A\00", align 1{{$}}
// CHECK: {{^}}@1 = private unnamed_addr constant [8 x i8] c"a = %s\0A\00", align 1{{$}}
// CHECK: {{^}}@2 = private unnamed_addr constant [10 x i8] c"a+b = %s\0A\00", align 1{{$}}
// CHECK: {{^}}@3 = private unnamed_addr constant [4 x i8] c"add\00", align 1{{$}}
