...
// CHECK: {{^}}@0 = private unnamed_addr constant [5 x i8] c"iter\00", align 1{{$}}
// CHECK: {{^}}@1 = private unnamed_addr constant [4 x i8] c"max\00", align 1{{$}}
// CHECK: {{^}}@2 = private unnamed_addr constant [6 x i8] c"print\00", align 1{{$}}
