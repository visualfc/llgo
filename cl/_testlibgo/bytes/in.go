...
// CHECK: {{^}}@2 = private unnamed_addr constant [3 x i8] c"buf", align 1{{$}}
// CHECK: {{^}}@3 = private unnamed_addr constant [2 x i8] c"Go", align 1{{$}}
// CHECK: {{^}}@4 = private unnamed_addr constant [2 x i8] c"go", align 1{{$}}
