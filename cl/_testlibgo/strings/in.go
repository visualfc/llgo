...
// CHECK: {{^}}@0 = private unnamed_addr constant [6 x i8] c"Hello ", align 1{{$}}
// CHECK: {{^}}@1 = private unnamed_addr constant [5 x i8] c"World", align 1{{$}}
// CHECK: {{^}}@2 = private unnamed_addr constant [4 x i8] c"len:", align 1{{$}}
// CHECK: {{^}}@3 = private unnamed_addr constant [4 x i8] c"cap:", align 1{{$}}
// CHECK: {{^}}@4 = private unnamed_addr constant [7 x i8] c"string:", align 1{{$}}
// CHECK: {{^}}@5 = private unnamed_addr constant [13 x i8] c"Hello, \E4\B8\96\E7\95\8C", align 1{{$}}
// CHECK: {{^}}@6 = private unnamed_addr constant [12 x i8] c"Hello, world", align 1{{$}}
