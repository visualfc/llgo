...
// CHECK: {{^}}@0 = private unnamed_addr constant [6 x i8] c"store:", align 1{{$}}
// CHECK: {{^}}@1 = private unnamed_addr constant [4 x i8] c"ret:", align 1{{$}}
// CHECK: {{^}}@2 = private unnamed_addr constant [2 x i8] c"v:", align 1{{$}}
// CHECK: {{^}}@3 = private unnamed_addr constant [4 x i8] c"swp:", align 1{{$}}
