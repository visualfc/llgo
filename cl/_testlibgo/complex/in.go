...
// CHECK: {{^}}@0 = private unnamed_addr constant [10 x i8] c"abs(3+4i):", align 1{{$}}
// CHECK: {{^}}@1 = private unnamed_addr constant [11 x i8] c"real(3+4i):", align 1{{$}}
// CHECK: {{^}}@2 = private unnamed_addr constant [11 x i8] c"imag(3+4i):", align 1{{$}}
