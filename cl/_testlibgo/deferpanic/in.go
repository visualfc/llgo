...
// CHECK: {{^}}@0 = private unnamed_addr constant [14 x i8] c"panic in defer", align 1{{$}}
// CHECK: {{^}}@1 = private unnamed_addr constant [6 x i8] c"string", align 1{{$}}
// CHECK: {{^}}@2 = private unnamed_addr constant [8 x i8] c"run main", align 1{{$}}
...
// CHECK-NEXT:   store ptr blockaddress(@"{{.*}}/cl/_testlibgo/deferpanic.main", %_llgo_7), ptr %8, align 8
...
// CHECK-NEXT:   store %"{{.*}}/runtime/internal/runtime.String" { ptr @0, i64 14 }, ptr %16, align 8
...
// CHECK-NEXT:   store %"{{.*}}/runtime/internal/runtime.eface" %17, ptr %22, align 8
...
// CHECK-NEXT:   store ptr blockaddress(@"{{.*}}/cl/_testlibgo/deferpanic.main", %_llgo_6), ptr %9, align 8
// CHECK-NEXT:   br label %_llgo_2
// CHECK-EMPTY:
// CHECK-NEXT: _llgo_5:                                          ; preds = %_llgo_0
// CHECK-NEXT:   store ptr blockaddress(@"{{.*}}/cl/_testlibgo/deferpanic.main", %_llgo_3), ptr %9, align 8
// CHECK-NEXT:   %23 = load ptr, ptr %8, align 8
// CHECK-NEXT:   indirectbr ptr %23, [label %_llgo_3, label %_llgo_7, label %_llgo_2]
// CHECK-EMPTY:
// CHECK-NEXT: _llgo_6:                                          ; preds = %_llgo_7
// CHECK-NEXT:   ret void
// CHECK-EMPTY:
// CHECK-NEXT: _llgo_7:                                          ; preds = %_llgo_5, %_llgo_9
// CHECK-NEXT:   store ptr blockaddress(@"{{.*}}/cl/_testlibgo/deferpanic.main", %_llgo_3), ptr %8, align 8
// CHECK-NEXT:   %24 = load i64, ptr %7, align 8
// CHECK-NEXT:   call void @"{{.*}}/cl/_testlibgo/deferpanic.main$1"()
// CHECK-NEXT:   %25 = load %"{{.*}}/runtime/internal/runtime.Defer", ptr %2, align 8
// CHECK-NEXT:   %26 = extractvalue %"{{.*}}/runtime/internal/runtime.Defer" %25, 2
// CHECK-NEXT:   call void @"{{.*}}/runtime/internal/runtime.SetThreadDefer"(ptr %26)
// CHECK-NEXT:   %27 = load ptr, ptr %9, align 8
// CHECK-NEXT:   indirectbr ptr %27, [label %_llgo_3, label %_llgo_6]
// CHECK-EMPTY:
// CHECK-NEXT: _llgo_8:                                          ; preds = %_llgo_2
// CHECK-NEXT:   %28 = load ptr, ptr %10, align 8
// CHECK-NEXT:   %29 = load { ptr, i64, %"{{.*}}/runtime/internal/runtime.eface" }, ptr %28, align 8
// CHECK-NEXT:   %30 = extractvalue { ptr, i64, %"{{.*}}/runtime/internal/runtime.eface" } %29, 0
// CHECK-NEXT:   store ptr %30, ptr %10, align 8
// CHECK-NEXT:   %31 = extractvalue { ptr, i64, %"{{.*}}/runtime/internal/runtime.eface" } %29, 2
