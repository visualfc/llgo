...
// CHECK-DAG: @"_llgo_{{.*}}/cl/_testlto/globaldce_interface_matrix.T1" = weak_odr constant {{.*}}, !type ![[T1A:[0-9]+]], !type ![[T1AR:[0-9]+]], !type ![[T1B:[0-9]+]], !type ![[T1BR:[0-9]+]], !type ![[T1C:[0-9]+]], !type ![[T1CR:[0-9]+]], !vcall_visibility
// CHECK-DAG: @"*_llgo_{{.*}}/cl/_testlto/globaldce_interface_matrix.T2" = weak_odr constant {{.*}}, !type ![[T2A:[0-9]+]], !type ![[T2AR:[0-9]+]], !type ![[T2B:[0-9]+]], !type ![[T2BR:[0-9]+]], !type ![[T2C:[0-9]+]], !type ![[T2CR:[0-9]+]], !vcall_visibility
