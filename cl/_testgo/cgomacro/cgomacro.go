...
// CHECK: {{^}}@0 = private unnamed_addr constant [7 x i8] c"hello\0A\00", align 1{{$}}
// CHECK: {{^}}@214 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1{{$}}
// CHECK: {{^}}@215 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1{{$}}
// CHECK: {{^}}@216 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1{{$}}
...
// CHECK-NEXT:   %0 = call ptr @"{{.*}}/cl/_testgo/cgomacro._Cmacro_stdout"()
// CHECK-NEXT:   %1 = insertvalue %"{{.*}}/runtime/internal/runtime.eface" { ptr @"*_llgo_{{.*}}/cl/_testgo/cgomacro._Ctype_struct___sFILE", ptr undef }, ptr %0, 1
// CHECK-NEXT:   %2 = call i32 @"{{.*}}/cl/_testgo/cgomacro._Cfunc_fputs"(ptr @214, ptr %0)
// CHECK-NEXT:   ret i32 %2
// CHECK-NEXT: }
...
// CHECK-NEXT:   %0 = call ptr @"{{.*}}/cl/_testgo/cgomacro._Cmacro_stdout"()
// CHECK-NEXT:   %1 = insertvalue %"{{.*}}/runtime/internal/runtime.eface" { ptr @"*_llgo_{{.*}}/cl/_testgo/cgomacro._Ctype_struct___sFILE", ptr undef }, ptr %0, 1
// CHECK-NEXT:   %2 = call i32 @"{{.*}}/cl/_testgo/cgomacro._Cfunc_fputs"(ptr @215, ptr %0)
// CHECK-NEXT:   ret i32 %2
// CHECK-NEXT: }
...
// CHECK-NEXT:   %0 = call ptr @"{{.*}}/cl/_testgo/cgomacro._Cmacro_stdout"()
// CHECK-NEXT:   %1 = insertvalue %"{{.*}}/runtime/internal/runtime.eface" { ptr @"*_llgo_{{.*}}/cl/_testgo/cgomacro._Ctype_struct___sFILE", ptr undef }, ptr %0, 1
// CHECK-NEXT:   %2 = call i32 @"{{.*}}/cl/_testgo/cgomacro._Cfunc_fputs"(ptr @216, ptr %0)
// CHECK-NEXT:   ret i32 %2
// CHECK-NEXT: }
