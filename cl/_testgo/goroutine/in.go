...
// CHECK: {{^}}@1 = private unnamed_addr constant [16 x i8] c"Hello, goroutine", align 1{{$}}
// CHECK: {{^}}@2 = private unnamed_addr constant [1 x i8] c".", align 1{{$}}
...
// CHECK-NEXT:   %1 = call ptr @"{{.*}}/runtime/internal/runtime.AllocRoot"(i64 16)
...
// CHECK-NEXT:   %4 = alloca %"{{.*}}/runtime/internal/clite/pthread.Attr", align 8
// CHECK-NEXT:   %5 = call i32 @"{{.*}}/runtime/internal/runtime.InitThreadAttr"(ptr %4)
// CHECK-NEXT:   %6 = call i32 @"{{.*}}/runtime/internal/runtime.CreateThread"(ptr %3, ptr %4, ptr @"{{.*}}/cl/_testgo/goroutine._llgo_routine$1", ptr %1)
// CHECK-NEXT:   %7 = call i32 @"{{.*}}/runtime/internal/runtime.DestroyThreadAttr"(ptr %4)
// CHECK-NEXT:   %8 = call ptr @"{{.*}}/runtime/internal/runtime.AllocU"(i64 8)
// CHECK-NEXT:   %9 = getelementptr inbounds { ptr }, ptr %8, i32 0, i32 0
// CHECK-NEXT:   store ptr %0, ptr %9, align 8
// CHECK-NEXT:   %10 = insertvalue { ptr, ptr } { ptr @"{{.*}}/cl/_testgo/goroutine.main$1", ptr undef }, ptr %8, 1
// CHECK-NEXT:   %11 = call ptr @"{{.*}}/runtime/internal/runtime.AllocRoot"(i64 32)
// CHECK-NEXT:   %12 = getelementptr inbounds { { ptr, ptr }, %"{{.*}}/runtime/internal/runtime.String" }, ptr %11, i32 0, i32 0
// CHECK-NEXT:   store { ptr, ptr } %10, ptr %12, align 8
// CHECK-NEXT:   %13 = getelementptr inbounds { { ptr, ptr }, %"{{.*}}/runtime/internal/runtime.String" }, ptr %11, i32 0, i32 1
// CHECK-NEXT:   store %"{{.*}}/runtime/internal/runtime.String" { ptr @1, i64 16 }, ptr %13, align 8
...
// CHECK-NEXT:   %17 = call i32 @"{{.*}}/runtime/internal/runtime.CreateThread"(ptr %14, ptr %15, ptr @"{{.*}}/cl/_testgo/goroutine._llgo_routine$2", ptr %11)
...
// CHECK-NEXT:   %19 = load i1, ptr %0, align 1
