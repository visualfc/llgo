...
// ARM64-NEXT: [[CBYTES:%.*]] = call ptr [[CBYTES_CODE]](ptr swiftself [[CBYTES_CALL_ENV]])
// AMD64-NEXT: [[CBYTES:%.*]] = call ptr [[CBYTES_CODE]](ptr nest [[CBYTES_CALL_ENV]])
...
// ARM64-NEXT: [[GO_BYTES:%.*]] = call %"{{.*}}Slice" [[GOBYTES_CODE]](ptr swiftself [[GOBYTES_CALL_ENV]])
// AMD64-NEXT: [[GO_BYTES:%.*]] = call %"{{.*}}Slice" [[GOBYTES_CODE]](ptr nest [[GOBYTES_CALL_ENV]])
...
// ARM64-LABEL: define ptr @"main.main$1"(ptr swiftself %0){{.*}} {
// AMD64-LABEL: define ptr @"main.main$1"(ptr nest %0){{.*}} {
...
// ARM64-LABEL: define %"{{.*}}Slice" @"main.main$2"(ptr swiftself %0){{.*}} {
// AMD64-LABEL: define %"{{.*}}Slice" @"main.main$2"(ptr nest %0){{.*}} {
...
// ARM64-LABEL: define void @"main.main$3"(ptr swiftself %0){{.*}} {
// AMD64-LABEL: define void @"main.main$3"(ptr nest %0){{.*}} {
...
// ARM64-LABEL: define void @"main.main$4"(ptr swiftself %0){{.*}} {
// AMD64-LABEL: define void @"main.main$4"(ptr nest %0){{.*}} {
