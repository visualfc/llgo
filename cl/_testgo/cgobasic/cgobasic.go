...
// CHECK: {{^}}@0 = private unnamed_addr constant [13 x i8] c"Hello, World!", align 1{{$}}
// CHECK: {{^}}@1 = private unnamed_addr constant [29 x i8] c"Converted back to Go string: ", align 1{{$}}
// CHECK: {{^}}@2 = private unnamed_addr constant [23 x i8] c"Length-limited string: ", align 1{{$}}
// CHECK: {{^}}@3 = private unnamed_addr constant [33 x i8] c"Converted back to Go byte slice: ", align 1{{$}}
// CHECK: {{^}}@5 = private unnamed_addr constant [14 x i8] c"sqrt(%v) = %v\0A", align 1{{$}}
// CHECK: {{^}}@6 = private unnamed_addr constant [13 x i8] c"sin(%v) = %v\0A", align 1{{$}}
// CHECK: {{^}}@7 = private unnamed_addr constant [13 x i8] c"cos(%v) = %v\0A", align 1{{$}}
// CHECK: {{^}}@8 = private unnamed_addr constant [13 x i8] c"log(%v) = %v\0A", align 1{{$}}
