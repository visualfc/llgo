...
// CHECK: {{^}}@18 = private unnamed_addr constant [3 x i8] c"ID:", align 1{{$}}
...
// CHECK-NEXT:   call void @"{{.*}}/runtime/internal/runtime.PrintString"(%"{{.*}}/runtime/internal/runtime.String" { ptr @18, i64 3 })
