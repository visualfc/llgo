...
// CHECK: {{^}}@1 = private unnamed_addr constant [46 x i8] c"return order mismatch: got (%d,%d), want (2,2)", align 1{{$}}
// CHECK: {{^}}@3 = private unnamed_addr constant [2 x i8] c"ok", align 1{{$}}
...
// CHECK-NEXT:   %6 = icmp ne i64 %5, 2
// CHECK-NEXT:   br i1 %6, label %_llgo_1, label %_llgo_3
// CHECK-EMPTY:
...
// CHECK-NEXT:   %9 = call ptr @"{{.*}}/runtime/internal/runtime.AllocZ"(i64 32)
// CHECK-NEXT:   %10 = getelementptr inbounds %"{{.*}}/runtime/internal/runtime.eface", ptr %9, i64 0
// CHECK-NEXT:   %11 = call ptr @"{{.*}}/runtime/internal/runtime.AllocU"(i64 8)
// CHECK-NEXT:   store i64 %8, ptr %11, align 8
...
// CHECK-NEXT:   %13 = getelementptr inbounds %"{{.*}}/runtime/internal/runtime.eface", ptr %9, i64 1
...
// CHECK-NEXT:   %16 = insertvalue %"{{.*}}/runtime/internal/runtime.Slice" undef, ptr %9, 0
// CHECK-NEXT:   %17 = insertvalue %"{{.*}}/runtime/internal/runtime.Slice" %16, i64 2, 1
// CHECK-NEXT:   %18 = insertvalue %"{{.*}}/runtime/internal/runtime.Slice" %17, i64 2, 2
// CHECK-NEXT:   %19 = call %"{{.*}}/runtime/internal/runtime.String" @fmt.Sprintf(%"{{.*}}/runtime/internal/runtime.String" { ptr @1, i64 46 }, %"{{.*}}/runtime/internal/runtime.Slice" %18)
// CHECK-NEXT:   %20 = call ptr @"{{.*}}/runtime/internal/runtime.AllocU"(i64 16)
// CHECK-NEXT:   store %"{{.*}}/runtime/internal/runtime.String" %19, ptr %20, align 8
...
// CHECK-NEXT:   %1 = getelementptr inbounds %"{{.*}}/cl/_testgo/returnorder.state", ptr %0, i32 0, i32 0
// CHECK-NEXT:   store i64 1, ptr %1, align 8
// CHECK-NEXT:   %2 = call i64 @"{{.*}}/cl/_testgo/returnorder.(*state).mutate"(ptr %0, i64 2)
// CHECK-NEXT:   %3 = load %"{{.*}}/cl/_testgo/returnorder.state", ptr %0, align 8
// CHECK-NEXT:   %4 = insertvalue { %"{{.*}}/cl/_testgo/returnorder.state", i64 } undef, %"{{.*}}/cl/_testgo/returnorder.state" %3, 0
// CHECK-NEXT:   %5 = insertvalue { %"{{.*}}/cl/_testgo/returnorder.state", i64 } %4, i64 %2, 1
// CHECK-NEXT:   ret { %"{{.*}}/cl/_testgo/returnorder.state", i64 } %5
// CHECK-NEXT: }
