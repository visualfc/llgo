...
// CHECK: {{^}}@6 = private unnamed_addr constant [57 x i8] c"struct{$f func(string, int) string; $data unsafe.Pointer}", align 1{{$}}
// CHECK: {{^}}@7 = private unnamed_addr constant [3 x i8] c"abc", align 1{{$}}
// CHECK: {{^}}@8 = private unnamed_addr constant [6 x i8] c"abcabc", align 1{{$}}
...
// CHECK-NEXT:   %5 = call ptr @"{{.*}}/runtime/internal/runtime.AssertNilDerefPtr"(ptr %4)
// CHECK-NEXT:   %6 = load %reflect.Value, ptr %5, align 8
// CHECK-NEXT:   %7 = call %"{{.*}}/runtime/internal/runtime.String" @reflect.Value.String(%reflect.Value %6)
// CHECK-NEXT:   %8 = extractvalue %"{{.*}}/runtime/internal/runtime.Slice" %0, 0
// CHECK-NEXT:   %9 = extractvalue %"{{.*}}/runtime/internal/runtime.Slice" %0, 1
// CHECK-NEXT:   %10 = icmp uge i64 1, %9
// CHECK-NEXT:   call void @"{{.*}}/runtime/internal/runtime.CheckIndexRange"(i1 %10, i64 1, i1 true, i64 %9)
// CHECK-NEXT:   %11 = getelementptr inbounds %reflect.Value, ptr %8, i64 1
// CHECK-NEXT:   %12 = call ptr @"{{.*}}/runtime/internal/runtime.AssertNilDerefPtr"(ptr %11)
// CHECK-NEXT:   %13 = load %reflect.Value, ptr %12, align 8
// CHECK-NEXT:   %14 = call i64 @reflect.Value.Int(%reflect.Value %13)
// CHECK-NEXT:   %15 = call %"{{.*}}/runtime/internal/runtime.String" @strings.Repeat(%"{{.*}}/runtime/internal/runtime.String" %7, i64 %14)
...
// CHECK-NEXT:   store %"{{.*}}/runtime/internal/runtime.String" %15, ptr %18, align 8
...
// CHECK-NEXT:   ret %"{{.*}}/runtime/internal/runtime.Slice" %23
// CHECK-NEXT: }
