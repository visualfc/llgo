...
define dso_local i32 @demo1(i32 %0) #0 {
  ...
  %7 = bitcast [1 x i16]* %6 to i8*
  %8 = bitcast i32* %4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 2 %7, i8* align 4 %8, i32 2, i1 false)
  %9 = bitcast %struct.array1* %2 to i8*
  %10 = bitcast %struct.array1* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 2 %9, i8* align 2 %10, i32 2, i1 false)
  %11 = getelementptr inbounds %struct.array1, %struct.array1* %2, i32 0, i32 0
  %12 = bitcast i32* %5 to i8*
  %13 = bitcast [1 x i16]* %11 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 4 %12, i8* align 2 %13, i32 2, i1 false)
...
define dso_local [2 x i32] @demo3([2 x i32] %0) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 2 %7, i8* align 4 %8, i32 6, i1 false)
  %9 = bitcast %struct.array3* %2 to i8*
  %10 = bitcast %struct.array3* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 2 %9, i8* align 2 %10, i32 6, i1 false)
  %11 = getelementptr inbounds %struct.array3, %struct.array3* %2, i32 0, i32 0
  %12 = bitcast [2 x i32]* %5 to i8*
  %13 = bitcast [3 x i16]* %11 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 4 %12, i8* align 2 %13, i32 6, i1 false)
...
define dso_local [2 x i32] @demo4([2 x i32] %0) #0 {
  ...
  store [2 x i32] %0, [2 x i32]* %5, align 2
  ...
  %10 = load [2 x i32], [2 x i32]* %9, align 2
  ret [2 x i32] %10
}

; Function Attrs: noinline nounwind optnone
define dso_local void @demo5(%struct.array5* noalias sret(%struct.array5) align 2 %0, %struct.array5* noundef %1) #0 {
  %3 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone
define dso_local void @demo6(%struct.array6* noalias sret(%struct.array6) align 2 %0, %struct.array6* noundef %1) #0 {
  %3 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone
define dso_local void @demo7(%struct.array7* noalias sret(%struct.array7) align 2 %0, %struct.array7* noundef %1) #0 {
  %3 = alloca i8*, align 4
...
; Function Attrs: noinline nounwind optnone
define dso_local void @demo8(%struct.array8* noalias sret(%struct.array8) align 2 %0, %struct.array8* noundef %1) #0 {
  %3 = alloca i8*, align 4
