...
define dso_local [2 x i32] @demo10([2 x i32] %0) #0 {
  ...
  %4 = bitcast %struct.point10* %3 to [2 x i32]*
  store [2 x i32] %0, [2 x i32]* %4, align 4
  %5 = bitcast %struct.point10* %2 to i8*
  %6 = bitcast %struct.point10* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 4 %5, i8* align 4 %6, i32 8, i1 false)
  %7 = bitcast %struct.point10* %2 to [2 x i32]*
  %8 = load [2 x i32], [2 x i32]* %7, align 4
  ret [2 x i32] %8
}
...
define dso_local [2 x i32] @demo16([2 x i32] %0) #0 {
  ...
  %4 = bitcast %struct.point16* %3 to [2 x i32]*
  store [2 x i32] %0, [2 x i32]* %4, align 4
  %5 = bitcast %struct.point16* %2 to i8*
  %6 = bitcast %struct.point16* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 4 %5, i8* align 4 %6, i32 8, i1 false)
  %7 = bitcast %struct.point16* %2 to [2 x i32]*
  %8 = load [2 x i32], [2 x i32]* %7, align 4
  ret [2 x i32] %8
}
...
define dso_local [2 x i32] @demo25([2 x i32] %0) #0 {
  ...
  %4 = bitcast %struct.point25* %3 to [2 x i32]*
  store [2 x i32] %0, [2 x i32]* %4, align 4
  %5 = bitcast %struct.point25* %2 to i8*
  %6 = bitcast %struct.point25* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 4 %5, i8* align 4 %6, i32 8, i1 false)
  %7 = bitcast %struct.point25* %2 to [2 x i32]*
  %8 = load [2 x i32], [2 x i32]* %7, align 4
  ret [2 x i32] %8
}
...
define dso_local [2 x i32] @demo26([2 x i32] %0) #0 {
  ...
  %4 = bitcast %struct.point26* %3 to [2 x i32]*
  store [2 x i32] %0, [2 x i32]* %4, align 4
  %5 = bitcast %struct.point26* %2 to i8*
  %6 = bitcast %struct.point26* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 4 %5, i8* align 4 %6, i32 8, i1 false)
  %7 = bitcast %struct.point26* %2 to [2 x i32]*
  %8 = load [2 x i32], [2 x i32]* %7, align 4
  ret [2 x i32] %8
}
...
define dso_local [2 x i32] @demo27([2 x i32] %0) #0 {
  ...
  %4 = bitcast %struct.point27* %3 to [2 x i32]*
  store [2 x i32] %0, [2 x i32]* %4, align 4
  %5 = bitcast %struct.point27* %2 to i8*
  %6 = bitcast %struct.point27* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 4 %5, i8* align 4 %6, i32 8, i1 false)
  %7 = bitcast %struct.point27* %2 to [2 x i32]*
  %8 = load [2 x i32], [2 x i32]* %7, align 4
  ret [2 x i32] %8
}
