...
@_llgo_main.Task = weak_odr constant { %"runtime/abi.StructType", %"runtime/abi.UncommonType", [2 x %"runtime/abi.Method"] } {
  ...
  [2 x %"runtime/abi.Method"] [
    %"runtime/abi.Method" { %"runtime.String" { ptr @method.drop, i64 4 }, ptr @_llgo_func$run, ptr @"main.(*Task).Drop", ptr @"__llgo_stub.main.Task.Drop" },
    %"runtime/abi.Method" { %"runtime.String" { ptr @method.run, i64 3 }, ptr @_llgo_func$run, ptr @"main.(*Task).Run", ptr @"__llgo_stub.main.Task.Run" }
  ]
}, align 8

@"*_llgo_main.Task" = weak_odr constant { %"runtime/abi.PtrType", %"runtime/abi.UncommonType", [2 x %"runtime/abi.Method"] } {
  %"runtime/abi.PtrType" {
