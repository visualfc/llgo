...
func TestDwarfLinkerArgs(t *testing.T) {
	tests := []struct {
		...
		{name: "safe default c-shared", conf: Config{BuildMode: BuildModeCShared, OmitDWARFByDefault: true}, target: configurableDebugInfo()},
...
func TestEffectiveOmitDWARF(t *testing.T) {
	tests := []struct {
		...
		{name: "safe default c-shared", conf: Config{BuildMode: BuildModeCShared, OmitDWARFByDefault: true}},
		{name: "safe default c-archive", conf: Config{BuildMode: BuildModeCArchive, OmitDWARFByDefault: true}},
...
func TestShouldEmitDebugInfo(t *testing.T) {
	tests := []struct {
		...
		{name: "c-shared safe default", conf: Config{Mode: ModeBuild, BuildMode: BuildModeCShared, OmitDWARFByDefault: true}, want: true},
		{name: "c-archive safe default", conf: Config{Mode: ModeBuild, BuildMode: BuildModeCArchive, OmitDWARFByDefault: true}, want: true},
