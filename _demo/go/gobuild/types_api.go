...
func testTypesAPI() {
	...
	testTypesObjectsAPI()
	testTypesScopeAPI()
	testTypesPackageMetadataAPI()
	testTypesNamedAPI()
	testTypesInterfaceAPI()
	testTypesStructAPI()
	testTypesSignatureAPI()
	testTypesTupleAPI()
	testTypesArrayAPI()
	testTypesSliceAPI()
	testTypesPointerAPI()
	testTypesMapAPI()
	testTypesChanAPI()
	testTypesComparisonAPI()
	testTypesCheckingAPI()
	testTypesStringsAPI()
	testTypesLookupAPI()
	testTypesUtilitiesAPI()
}

func testTypesBasicAPI() {
...
func testTypesPackageMetadataAPI() {
	fmt.Println("\n=== Test Package ===")
