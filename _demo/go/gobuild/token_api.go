...
func testTokenAPI() {
	...
	testTokenFileSetAPI()
	testTokenFileAPI()
	testTokenPositionAPI()
	testTokenPrecedenceAPI()
	testTokenKeywordsAPI()
	testTokenUtilitiesAPI()
}

func testTokenPosAPI() {
