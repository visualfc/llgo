...
// record count, amd64 to _setjmpex with the current frame, and arm64 to LLGo's
// ABI-only context entry. The latter avoids UCRT's virtual unwind because Go
// defers are unwound by LLGo itself. A Go or C wrapper would save the wrapper's
